...

{
  ...
  ColeGenesisFile = ./staging + "/cole-genesis.json";
  ColeGenesisHash = "c6a004d3d178f600cd8caa10abbebe1549bef878f0665aea2903472d5abf7323";
  SophieGenesisFile = ./staging + "/sophie-genesis.json";
  SophieGenesisHash = "cbb0f57a001120ef11d97b943ce6953b75d26adc11dc68451e9dec7989a62c85";
  AurumGenesisFile = ./staging + "/aurum-genesis.json";
